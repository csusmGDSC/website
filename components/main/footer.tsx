...
const Footer = () => {
  return (
    <footer>
      <div className="w-full sm:h-[12rem] pb-4 sm:pb-0 border-t border-b-neutral-200 items-center flex flex-col">
        <div className="h-full md:max-w-[90%] xl:max-w-[60%] w-full grid grid-cols-1 sm:grid-cols-4">
          ...
          <div className="flex flex-col text-sm gap-2 pt-10 pl-4 sm:pl-0 sm:ml-auto">
      ...
      <div className="w-full h-12 bg-neutral-100 flex flex-col items-center justify-center">
        <div className="md:max-w-[90%] xl:max-w-[60%] w-full flex flex-row items-center justify-between">
