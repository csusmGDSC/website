...
export const HorizontalTopicCard: React.FC<TopicCardProps> = ({
  ...
  return (
    <div className="w-full h-[230px] border flex flex-row justify-center sm:justify-between items-center px-8 rounded-lg space-x-4 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] hover:shadow-lg transition-all">
      {/* TOPIC CARD CONTENT */}
...
export const VerticalTopicCard: React.FC<TopicCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "w-full border flex flex-col items-center p-4 pr-8  rounded-lg space-x-4 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] hover:shadow-lg transition-all",
        className
      )}
    >
      {/* IMAGE OF TOPIC CARD */}
